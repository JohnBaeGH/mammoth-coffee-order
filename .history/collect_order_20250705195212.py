...
MENU = {
    "32oz": [
        "매머드 커피", "아이스티", "아샷추 아이스티", "스노우 매머드 커피", 
        "허니베리 홍초 에이드", "패션 오렌지 아이스티", "디카페인 매머드 커피", 
        "디카페인 아샷추 아이스티", "디카페인 스노우 매머드 커피"
    ],
    "커피": [
    ...
    "콜드브루": [
        ...
        "디카페인 코코넛 크림 콜드브루 라떼", "매머드 콜드브루 원액", 
        "매머드 콜드브루 디카페인 원액"
    ],
    "논커피": [
    ...
    "티·에이드": [
        ...
        "자몽 티 / 에이드", "블루레몬 티 / 에이드", "청포도 에이드", "수박 주스"
    ],
    "프라페·블렌디드": [
    ...
    "푸드": [
        "매머드 초콜릿 칩 쿠키", "우유 크림 크로슈", "초코 덮인 크로슈", 
        "바삭 한입 페스츄리 약과", "쫀득 한입 고구마말랭이", "근대골목 생크림 단팥빵", 
        "근대골목 단팥빵", "꿀 우유 크림 도넛", "미니 매머드 빵", "바나나 쿠키", 
        "브라우니 쿠키", "끼리 플레인 치즈 스틱 케이크", "매머드 크룽지", 
        "끼리 쿠키앤 크림 치즈 스틱 케이크", "매머드 고메버터 플레인 스콘", 
        "초코 비스킷 슈", "매머드 초코 파운드 케이크", "매머드 고메버터 초코 스콘", 
        "바닐라 비스킷 슈", "바스크 치즈 케이크", "매머드 레몬 파운드 케이크", 
        "매머드 초콜릿 칩 쿠키", "매머드 마카다미아 쿠키", "햄&치즈 대만식 샌드위치", 
        "카야 대만식 샌드위치", "미니 쁘띠 마카롱", "바닐라 마카롱", "초콜릿 마카롱", 
        "망고 마카롱", "민트초코 마카롱", "라즈베리 마카롱", "블루베리 마카롱", 
        "마스카포네 티라미수", "폭탄 카스테라", "밀크 크레이프", "매머드 렐리시 핫도그", 
        "매머드 미트 칠리 핫도그", "매머드 렐리시 핫도그 세트", "매머드 미트 칠리 핫도그 세트", 
        "크로플", "치즈 크로플", "에그 타르트", "클래식 치즈 케이크", "제리의 치즈 케이크", 
        "쇼콜라 아메르 케이크", "당근 케이크", "잉글리쉬 머핀 샌드위치", "멜팅 치즈 샌드위치", 
        "허니브레드", "플레인 베이글", "블루베리 베이글", "베이컨 치즈 샌드위치", 
        "에그 샐러드 샌드위치", "튜나 샌드위치", "클럽 샌드위치", "베이컨 치즈 샌드위치 세트", 
        "에그 샐러드 샌드위치 세트", "튜나 샌드위치 세트", "클럽 샌드위치 세트"
    ],
    "RTD": [
        "뽀로로(보리차)", "뽀로로(밀크)", "뽀로로(딸기)", "뽀로로(사과)", 
        "아쿠아파나(병)", "골드메달 애플주스(병)", "로리나(핑크레몬)", "창소다워터", 
        "분다버그(망고)", "분다버그(진저비어)", "분다버그(핑크자몽)", "매머드 탄산수"
    ],
    "MD": [
        "매머드 캡슐 커피", "매머드 캡슐 커피 디카페인", "매머드 캡슐 커피 다크 로스트", 
        "매머드 콜드브루 스틱커피", "매머드 매트블랙 콜드 텀블러", "매머드 리유저블 핫 컵"
    ]
}
