...
class CoffeeOrderApp:
    ...
    def create_widgets(self):
        ...
        # 3-1. 카테고리 & 온도
        cat_temp_frame = ttk.Frame(menu_select_frame, style='TFrame', background=FRAME_COLOR)
        ...
        temp_frame = ttk.Frame(cat_temp_frame, style='Card.TFrame')
        ...
        # 3-2. 메뉴 이미지 스크롤 영역
        canvas_frame = ttk.Frame(menu_select_frame, style='Card.TFrame')
        ...
        ttk.Button(bottom_frame, text="모든 인원 주문 완료", command=self.show_final_order).grid(row=0, column=1, sticky='ew', padx=(5,0))
